  ...
  return (
    <>
      ...
      <a 
        ...
        className="block lg:hidden fixed top-[30px] right-0 transform -translate-y-1/2 bg-[#ff6600] text-white px-4 py-2 rounded-l-lg shadow-lg text-sm font-semibold hover:bg-[#cc5200] transition-all animate-bounce"
      >
